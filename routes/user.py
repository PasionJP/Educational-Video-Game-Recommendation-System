...
def signup():
	if request.method == 'POST':
		...
		new_user = user_manager.signup(name, birthdate, email, password)
...
def show_user(id=None):
	...
	mygames = user_manager.getGamesList(id)
	# print("GAMES", mygames)
	return render_template("profile.html", user=d, games=mygames, g=g)
